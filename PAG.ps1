...
$DownloadUrl = 'https://app.action1.com/agent/c7ef8374-a01a-11ed-a35e-dd162913d97c/Windows/agent(PAG).msi' # This URL can be found here: https://app.action1.com/console/endpoints/add/step-1
