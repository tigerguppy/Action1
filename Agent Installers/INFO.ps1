...
$DownloadUrl = 'https://app.action1.com/agent/be476244-00e7-11f0-96e5-b97c286e13b8/Windows/agent(Info_Only).msi' # This URL can be found here: https://app.action1.com/console/endpoints/add/step-1
