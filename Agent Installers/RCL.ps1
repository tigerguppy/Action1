...
$DownloadUrl = 'https://app.action1.com/agent/277841e4-c115-11ed-882d-ad61a2da98b9/Windows/agent(RCL).msi' # This URL can be found here: https://app.action1.com/console/endpoints/add/step-1
