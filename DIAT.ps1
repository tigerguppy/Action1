...
$DownloadUrl = 'https://app.action1.com/agent/67ef53e4-9e55-11ed-ad89-8326ab1592bc/Windows/agent(DIAT).msi' # This URL can be found here: https://app.action1.com/console/endpoints/add/step-1
